...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineUILineInfoWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.UILineInfo);
        ...
        static int _g_get_startCharIdx(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.UILineInfo gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                LuaAPI.xlua_pushinteger(L, gen_to_be_invoked.startCharIdx);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_leading(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.UILineInfo gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                LuaAPI.lua_pushnumber(L, gen_to_be_invoked.leading);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_startCharIdx(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.UILineInfo gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                gen_to_be_invoked.startCharIdx = LuaAPI.xlua_tointeger(L, 2);
        ...
        static int _s_set_topY(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.UILineInfo gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                gen_to_be_invoked.topY = (float)LuaAPI.lua_tonumber(L, 2);
        ...
        static int _s_set_leading(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.UILineInfo gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                gen_to_be_invoked.leading = (float)LuaAPI.lua_tonumber(L, 2);
