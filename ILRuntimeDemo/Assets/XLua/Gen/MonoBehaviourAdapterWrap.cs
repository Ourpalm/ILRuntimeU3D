...
namespace XLua.CSObjectWrap
{
    ...
    public class MonoBehaviourAdapterWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MonoBehaviourAdapter);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new MonoBehaviourAdapter();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MonoBehaviourAdapter constructor!");
        ...
        static int _m_CreateCLRInstance(RealStatePtr L)
        {
		    try {
                ...
                MonoBehaviourAdapter gen_to_be_invoked = (MonoBehaviourAdapter)translator.FastGetCSObj(L, 1);
