...
namespace XLua.CSObjectWrap
{
    ...
    public class PerformanceWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "useLib", _g_get_useLib);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "useLib", _s_set_useLib);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_useLib(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                Performance gen_to_be_invoked = (Performance)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushstring(L, gen_to_be_invoked.useLib);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_useLib(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                Performance gen_to_be_invoked = (Performance)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.useLib = LuaAPI.lua_tostring(L, 2);
