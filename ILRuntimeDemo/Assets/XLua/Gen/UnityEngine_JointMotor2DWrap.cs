...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineJointMotor2DWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.JointMotor2D);
        ...
        static int _g_get_motorSpeed(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.JointMotor2D gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                LuaAPI.lua_pushnumber(L, gen_to_be_invoked.motorSpeed);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_maxMotorTorque(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.JointMotor2D gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                LuaAPI.lua_pushnumber(L, gen_to_be_invoked.maxMotorTorque);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_motorSpeed(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.JointMotor2D gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                gen_to_be_invoked.motorSpeed = (float)LuaAPI.lua_tonumber(L, 2);
        ...
        static int _s_set_maxMotorTorque(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.JointMotor2D gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                gen_to_be_invoked.maxMotorTorque = (float)LuaAPI.lua_tonumber(L, 2);
