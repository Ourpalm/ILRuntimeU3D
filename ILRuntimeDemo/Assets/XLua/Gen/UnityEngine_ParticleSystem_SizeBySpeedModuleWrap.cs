...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineParticleSystemSizeBySpeedModuleWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.ParticleSystem.SizeBySpeedModule);
        ...
        static int _g_get_enabled(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.SizeBySpeedModule gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
