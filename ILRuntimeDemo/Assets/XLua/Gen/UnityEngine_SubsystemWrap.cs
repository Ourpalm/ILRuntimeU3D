...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineSubsystemWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.Subsystem);
        ...
        {
            return LuaAPI.luaL_error(L, "UnityEngine.Subsystem does not have a constructor!");
        }
        ...
        static int _m_Start(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Subsystem gen_to_be_invoked = (UnityEngine.Subsystem)translator.FastGetCSObj(L, 1);
