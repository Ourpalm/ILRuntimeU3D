...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineParticleSystemColorBySpeedModuleWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.ParticleSystem.ColorBySpeedModule);
        ...
        static int _g_get_enabled(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.ColorBySpeedModule gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
