...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEnginePatchExtentsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.PatchExtents);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.Push(L, default(UnityEngine.PatchExtents));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.PatchExtents constructor!");
        ...
        static int _g_get_min(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.PatchExtents gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
