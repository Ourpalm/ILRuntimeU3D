...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineParticleSystemSizeOverLifetimeModuleWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.ParticleSystem.SizeOverLifetimeModule);
        ...
        static int _g_get_enabled(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.SizeOverLifetimeModule gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
        ...
        static int _g_get_sizeMultiplier(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.SizeOverLifetimeModule gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                LuaAPI.lua_pushnumber(L, gen_to_be_invoked.sizeMultiplier);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_sizeMultiplier(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.SizeOverLifetimeModule gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                gen_to_be_invoked.sizeMultiplier = (float)LuaAPI.lua_tonumber(L, 2);
