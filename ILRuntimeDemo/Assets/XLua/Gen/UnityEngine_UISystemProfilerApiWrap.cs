...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineUISystemProfilerApiWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.UISystemProfilerApi);
        ...
        {
            return LuaAPI.luaL_error(L, "UnityEngine.UISystemProfilerApi does not have a constructor!");
        }
        ...
        static int _m_BeginSample_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.UISystemProfilerApi.SampleType _type;translator.Get(L, 1, out _type);
                    
                    UnityEngine.UISystemProfilerApi.BeginSample( _type );
        ...
        static int _m_EndSample_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    UnityEngine.UISystemProfilerApi.EndSample( _type );
        ...
        static int _m_AddMarker_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    UnityEngine.UISystemProfilerApi.AddMarker( _name, _obj );
