...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineParticleSystemRotationBySpeedModuleWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.ParticleSystem.RotationBySpeedModule);
        ...
        static int _g_get_enabled(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.RotationBySpeedModule gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
