...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineJointSpringWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.JointSpring);
        ...
        static int _g_get_spring(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.JointSpring gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
        ...
        static int _g_get_targetPosition(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.JointSpring gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                LuaAPI.lua_pushnumber(L, gen_to_be_invoked.targetPosition);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_targetPosition(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.JointSpring gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                gen_to_be_invoked.targetPosition = (float)LuaAPI.lua_tonumber(L, 2);
