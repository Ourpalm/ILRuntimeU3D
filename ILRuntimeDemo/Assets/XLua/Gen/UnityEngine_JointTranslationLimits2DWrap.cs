...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineJointTranslationLimits2DWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.JointTranslationLimits2D);
        ...
        static int _g_get_min(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.JointTranslationLimits2D gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
