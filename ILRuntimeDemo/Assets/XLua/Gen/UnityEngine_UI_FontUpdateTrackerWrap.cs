...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineUIFontUpdateTrackerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.UI.FontUpdateTracker);
        ...
        static int _m_TrackText_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.UI.Text _t = (UnityEngine.UI.Text)translator.GetObject(L, 1, typeof(UnityEngine.UI.Text));
                    
                    UnityEngine.UI.FontUpdateTracker.TrackText( _t );
        ...
        static int _m_UntrackText_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    UnityEngine.UI.FontUpdateTracker.UntrackText( _t );
