...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineParticleSystemRotationOverLifetimeModuleWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.ParticleSystem.RotationOverLifetimeModule);
        ...
        static int _g_get_enabled(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.RotationOverLifetimeModule gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
