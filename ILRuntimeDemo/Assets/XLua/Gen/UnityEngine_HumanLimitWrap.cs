...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineHumanLimitWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.HumanLimit);
        ...
        static int _g_get_useDefaultValues(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.HumanLimit gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.useDefaultValues);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_axisLength(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.HumanLimit gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                LuaAPI.lua_pushnumber(L, gen_to_be_invoked.axisLength);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_useDefaultValues(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.HumanLimit gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                gen_to_be_invoked.useDefaultValues = LuaAPI.lua_toboolean(L, 2);
        ...
        static int _s_set_axisLength(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.HumanLimit gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                gen_to_be_invoked.axisLength = (float)LuaAPI.lua_tonumber(L, 2);
