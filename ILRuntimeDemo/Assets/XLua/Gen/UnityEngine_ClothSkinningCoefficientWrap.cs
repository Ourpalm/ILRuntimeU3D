...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineClothSkinningCoefficientWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.ClothSkinningCoefficient);
        ...
        static int _g_get_maxDistance(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ClothSkinningCoefficient gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
        ...
        static int _g_get_collisionSphereDistance(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ClothSkinningCoefficient gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                LuaAPI.lua_pushnumber(L, gen_to_be_invoked.collisionSphereDistance);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_collisionSphereDistance(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ClothSkinningCoefficient gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                gen_to_be_invoked.collisionSphereDistance = (float)LuaAPI.lua_tonumber(L, 2);
